...
import { Config as ConfigSchemaTyping } from '../schemas/WalletConfigTyping'
import { log } from '../winston'
import configSchema from '../schemas/WalletConfig.json'
const {
...
export class WalletConfig extends ConfigSchemaTyping {
